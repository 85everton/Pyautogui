...
pyautogui.PAUSE = 0.5
pyautogui.press('s')
pyautogui.alert("Total de descontos da promoção 1 deve ser R$ 1,00 e total da venda R$ 14,98, Caso os valores estiverem incorretos abortar a automação")
pyautogui.press('F4')
time.sleep(3)
...
pyautogui.PAUSE = 0.5
pyautogui.press('s')
pyautogui.alert("Total de descontos da promoção 5 deve ser R$ 13,95 e total da venda R$ 33,95, Caso os valores estiverem incorretos abortar a automação")
pyautogui.press('F4')
time.sleep(3)
